...
public class GameActivity extends AppCompatActivity {
    ...
    String uid, jugadaId = "", playerOneName = "", playerTwoName = "", ganadorId = "",abandonoId = "true";
    Jugada jugada;
        ...
        listenerJugada=db.collection("jugadas")
                ...
                .addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                        if (documentSnapshot.get("abandonoId").equals("true")){
                            bajarPuntuacion(3);
                            Toast.makeText(MyApp.getInstance(), "Has abandondado la partida, PERDISTE 3 PUNTOS", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                });
        ...
        listenerJugada = db.collection("jugadas")
                ...
                .addSnapshotListener(GameActivity.this, new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException e) {
                        ...
                        if(jugada.getAbandonoId().equals("true")) {
                            if(jugada.getJugadorDosId()!=(uid)) {
                                finish();
                            }
                        }
                    }
    ...
    private void initGame() {
        ...
        abandonoId = extras.getString(Constantes.ABANDONO_JUGADA_ID);
    ...
    public void mostrarDialogoGameOver() {
        ...
        View v = getLayoutInflater().inflate(R.layout.dialogo_gameover, null);
    ...
    private void bajarPuntuacion(int puntosConseguidos) {
        User jugadorActualizar = null;
        if(nombreJugador.equals(userPlayer1.getName())) {
            userPlayer1.setPoints(userPlayer1.getPoints() - puntosConseguidos);
            userPlayer1.setPartidasJugadas(userPlayer1.getPartidasJugadas() + 1);
